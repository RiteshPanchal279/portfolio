...
import "./contact.scss";
import { useInView, motion, FlatTree } from "framer-motion";
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_1ohe21l", "template_dbeij0j", formRef, {
        publicKey: "vjDtMruVYPUkfw_bb",
      })
      .then(
        () => {
          setSuccess(true);
